...
//this is for report of breast
import pdfreport1 from "./PDFworking/pdfreport1";

import pdfreportPatient from "./PDFworking/pdfreportPatient";
//option
...
import DiseaseOpt from "./componets/Pages/DoctorPortal/DiseaseOpt";
// MRI UPLOAD AND GET REPORT  DiseaseOpt

import GetReport1 from "./componets/Pages/DoctorPortal/GetReport1";
// Single Patient data show in table
import SinglePat from "./componets/Pages/DoctorPortal/SinglePat";
// Doc Request of signup
import DocReq from "./componets/Pages/adminPortal/DocReq";
import CityStats from "./componets/Pages/adminPortal/CityStats";
import Navbar from "./PDFworking/Navbar.js";

function App() {
  return (
    <Router>
      <Switch>
        <Route path="/viewPatientReport" component={pdfreportPatient}></Route>
        <Route path="/report" component={pdf} />
        <Route path="/report1" component={pdfreport1} />
        ...
        <PageWrapper>
          ...
          <ProtectedRoute path="/docrequest" component={DocReq} />
          ...
          <Route path="error" component={Error404} />
          <ProtectedRoute path="/getreport1" component={GetReport1} />
          <ProtectedRoute path="/diseaseopt" component={DiseaseOpt} />
        </PageWrapper>
      </Switch>
    </Router>
  );
