        ...
        <div id="output" style={{ color: "black" }}>
          ...
          <div class="container ">
            <div class="bg-light">
              ...
              <div>
                <table class="table text-center mb-5 align-slef-center">
                  <thead>
                    <tr>
            ...
            <div>
              ...
              <table class="table table-active text-center my-auto">
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <img src="img/bilal/withoutskull.jpg"></img>
                    </td>
                    <td>Yes</td>
                    <td>
