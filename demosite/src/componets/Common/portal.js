...
import FileUpload1 from "../Common/FileUpload1";
import SelectDisease from "../Common/SelectDisease";
...
import DocRequest from "../Pages/adminPortal/DocRequest";
import AddDoc from "../Common/AddDoctor";
import changeEmail from "../chnagedata/changeEmail";
import PatRequest from "../Pages/adminPortal/PatientRequest";
import allpat from "../patientData/getAllPat";
import CityStats from "../Pages/adminPortal/CityStats";
import CountryStats from "../Pages/adminPortal/CountryStats";
import MonthStats from "../Pages/adminPortal/MonthStats";
  ...
  patienthistory = async (e) => {
    ...
    if (this.state.w === 0) {
      ...
      <td>` +
            ...
            <a href="/viewPatientReport"> <button value="` +
            patientHistory.Report_ID[x] +
            `"
  ...
  allPatient = async (e) => {
    ...
    if (this.state.v === 0) {
      ...
      <td>` +
            ...
            `</td><td>
            <a href="/viewPatientReport"> <button
             class="far fa-eye pathistory" value=` +
            alldoctors.reportid[x] +
            `></button></a>
  </td>
    </tr>`
        );
            ...
            <ul className="navbar-nav ml-auto ml-md-0">
              ...
              >
                ...
                <Link className="dropdown-item" to="#">
                  ...
                  <Link
                    to="/login"
                    class="navbar-nav ml-auto btn btn-primary btn-lg bg-dark text-light "
                    onClick={Auth.logout}
                  >
              ...
              >
                <div className="sb-sidenav-menu">
                  <div className="nav">
                    ...
                    {this.props.docreqside && (
                      <Link className="nav-link" to="/docrequest">
                        <div className="sb-nav-link-icon">
                          <i className="fas fa-tachometer-alt"></i>
                        </div>
                        {/* Small Heading 03 of 1 */}
                ...
                <div className="container-fluid">
                  ...
                  <div className="">
                    <div className="card-header">
                      ...
                      {this.props.history11 && (
                        <div>
                          <h2>Patient List</h2>
                          <table
                            className="table table-hover table-bordered table-dark text-center"
                            onLoad={this.allPatientdata()}
                          >
                            <thead>
                              <tr>
                                <th scope="col">#</th>
                      ...
                      {this.props.DocRequest && <DocRequest />}
                      {this.props.PatRequest && <PatRequest />}

                      {/* Statistical Reporting */}

                      {/* {this.props.MonthStats && <MonthStats />} */}

                      {this.props.ProvinceStats && <CountryStats />}

                      {this.props.CityStats && <CityStats />}
                      {
                        //new addition for breast cancere
                      }
                      {this.props.SelectDisease && <SelectDisease />}
                      {this.props.FileUpload1 && <FileUpload1 />}
                    </div>
